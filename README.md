...
- As there is no installer, I'm trying to package all the .dlls inside the main package. If a release doesn't work, i suggest you to try building the project on your pc.
